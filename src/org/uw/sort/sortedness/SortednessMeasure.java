 ...
 * @since 2.0
 */
public class SortednessMeasure {
     ...
     * @since 3.1
     */
    public SortednessMeasure(final RankingAlgorithm rankingAlgorithm) {
        data = null;
     ...
     */
    public SortednessMeasure(final RealMatrix dataMatrix) {
     ...
     * @param rankingAlgorithm ranking algorithm
     */
    public SortednessMeasure(final RealMatrix dataMatrix, final RankingAlgorithm rankingAlgorithm) {
        this.rankingAlgorithm = rankingAlgorithm;
